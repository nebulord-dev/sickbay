...
describe("HealthPanel", () => {
  ...
  describe("displaying checks", () => {
    ...
    it("shows pass icon for passing checks", () => {
      const checks = [
        createCheck({ id: "eslint", name: "ESLint", status: "pass" }),
      ];
      const { lastFrame } = render(
        <HealthPanel
          checks={checks}
    ...
    it("shows fail icon for failing checks", () => {
      const checks = [
        createCheck({ id: "audit", name: "npm-audit", status: "fail", score: 20 }),
      ];
      const { lastFrame } = render(
        <HealthPanel
          checks={checks}
    ...
    it("shows warning icon for warning checks", () => {
      const checks = [
        createCheck({ id: "knip", name: "Knip", status: "warning", score: 65 }),
      ];
      const { lastFrame } = render(
        <HealthPanel
          checks={checks}
    ...
    it("shows score bar for each check", () => {
      const checks = [
        createCheck({ id: "eslint", name: "ESLint", score: 80 }),
      ];
      const { lastFrame } = render(
        <HealthPanel
          checks={checks}
    ...
    it("shows numeric score for each check", () => {
      const checks = [
        createCheck({ id: "eslint", name: "ESLint", score: 73 }),
      ];
      const { lastFrame } = render(
        <HealthPanel
          checks={checks}
