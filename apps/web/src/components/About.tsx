...
const CHECK_DESCRIPTIONS: Record<string, string> = {
  ...
  'todo-scanner': 'Finds TODO, FIXME, and HACK comments left in source code.',
  ...
  'heavy-deps': 'Identifies heavy or outdated dependencies that have lighter modern alternatives.',
  'react-perf':
...
export function About({ report }: AboutProps) {
  ...
  return (
    <div className="space-y-10 max-w-3xl">
      {/* Intro */}
      <section>
        <h1 className="text-2xl font-bold text-green-400 tracking-wider mb-2">SICKBAY</h1>
        <p className="text-gray-400 leading-relaxed">
          Sickbay is a zero-config project health dashboard. It runs a suite of checks across your
          codebase — dependencies, security, code quality, performance, and git hygiene — and
          produces a single weighted score so you can see the overall health of your project at a
          glance.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="mt-4 flex gap-4 text-xs text-gray-500">
          <span>
            <span className="text-green-400 font-mono font-bold">≥80</span> — healthy
          </span>
          <span>
            <span className="text-yellow-400 font-mono font-bold">60–79</span> — needs attention
          </span>
          <span>
            <span className="text-red-400 font-mono font-bold">&lt;60</span> — critical
          </span>
        </div>
      </section>
